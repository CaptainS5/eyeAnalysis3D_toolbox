...
for i = height(all_user_info):-1:1
    try
        ...
        if ~isempty(eyeTrial.eyeAligned(eyeTrial.eyeAligned.timestamp <= timestamp_to_end & eyeTrial.eyeAligned.timestamp >= timestamp_to_start, :))
            eyeTrial.eyeAligned = eyeTrial.eyeAligned(eyeTrial.eyeAligned.timestamp <= timestamp_to_end & eyeTrial.eyeAligned.timestamp >= timestamp_to_start, :);
        end
        ...
        timestamp_to_end = first_non_nan_row + minsToApply;
