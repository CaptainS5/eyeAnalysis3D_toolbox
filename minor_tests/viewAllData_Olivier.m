    ...
    for i = 1:height(all_user_info)
        ...
        switch field
            case 'CH20'
                a = 0;
                b = 10;
                eA = all_user_info.EyeTrial{i}.eyeAligned(all_user_info.EyeTrial{i}.eyeAligned.timestamp >= a & all_user_info.EyeTrial{i}.eyeAligned.timestamp <= b, :);
                hA = all_user_info.EyeTrial{i}.headAligned(all_user_info.EyeTrial{i}.headAligned.timestamp >= a & all_user_info.EyeTrial{i}.headAligned.timestamp <= b, :);
            case 'CH40'
                a = 515;
                b = 580;
        ...
        gH = [eA.gazePosHeadX eA.gazePosHeadY eA.gazePosHeadZ] / 1000;
        gH = gH(~any(isnan(gH), 2), :);
        % This is gaze position in world space from last 10 minutes
        gW = [eA.gazePosWorldX eA.gazePosWorldY eA.gazePosWorldZ] / 1000;
        gW = gW(~any(isnan(gW), 2), :);
        gW = [];
        for kkk = 1:size(gH, 1)
            gW = [gW ; rotatepoint(quaternion([-hA.qW, hA.qY, hA.qZ, hA.qX]), gH)];
        end
        % Get head rotation
        hR = [-hA.qW, hA.qY, hA.qZ, hA.qX];
...
plotGazeData(gazeHead1.CH20, gazeHead1.CH20, [dirPath1 'OL_GRID1_GIHead_'], 'world', 'ET-DDC Off', 'ET-DDC On');
%plotGazeData(gazeHead1.CH40, gazeHead1.CH40, [dirPath1 'SECTEST_OFF_GIHead_'], 'world', 'ET-DDC Off', 'ET-DDC On');
%plotGazeData(gazeHead1.CH60, gazeHead1.CH60, [dirPath1 'SECTEST_ON_GIHead_'], 'world', 'ET-DDC Off', 'ET-DDC On');
% plotGazeData(gazeWorld1.L10,  gazeWorld1.L10,  [dirPath1 '4TH_GIWorld_'], 'world', 'ET-DDC Off', 'ET-DDC On');
plotGazeData(gazeWorld1.CH20, gazeWorld1.CH20, [dirPath1 'OL_GRID1_GIWorld_'], 'world', 'ET-DDC Off', 'ET-DDC On');
%plotGazeData(gazeWorld1.CH40, gazeWorld1.CH40, [dirPath1 'SECTEST_OFF_GIWorld_'], 'world', 'ET-DDC Off', 'ET-DDC On');
%plotGazeData(gazeWorld1.CH60, gazeWorld1.CH60, [dirPath1 'SECTEST_ON_GIWorld_'], 'world', 'ET-DDC Off', 'ET-DDC On');
% plotGazeData(headWorld1.L10,  headWorld1.L10,  [dirPath2 '4TH_HIWorld_'], 'world', 'ET-DDC Off', 'ET-DDC On');
plotGazeData(headWorld1.CH20, headWorld1.CH20, [dirPath2 'OL_GRID1_HIWorld_'], 'world', 'ET-DDC Off', 'ET-DDC On');
%plotGazeData(headWorld1.CH40, headWorld1.CH40, [dirPath2 'SECTEST_OFF_HIWorld_'], 'world', 'ET-DDC Off', 'ET-DDC On');
%plotGazeData(headWorld1.CH60, headWorld1.CH60, [dirPath2 'SECTEST_ON_HIWorld_'], 'world', 'ET-DDC Off', 'ET-DDC On');
...
function smoothed_data = plotGazeData(data0, data1, supraLabel, coordSys, label0, label1)
    ...
    [theta, phi, ~] = cart2sph(data0.x, data0.y, data0.z);
    ...
    % hold off;
    % plot([167, 167], [0, 499], 'r--', LineWidth=2);  % 'r--' specifies a red dashed line
    % plot([209, 209], [0, 499], 'r--', LineWidth=2);  % 'r--' specifies a red dashed line
    % plot([250, 250], [0, 499], 'r--', LineWidth=2);  % 'r--' specifies a red dashed line
    % plot([293, 293], [0, 499], 'r--', LineWidth=2);  % 'r--' specifies a red dashed line
    % plot([336, 336], [0, 499], 'r--', LineWidth=2);  % 'r--' specifies a red dashed line
    % plot([0, 499], [167, 167], 'r--', LineWidth=2);  % 'r--' specifies a red dashed line
    % plot([0, 499], [250, 250], 'r--', LineWidth=2);  % 'r--' specifies a red dashed line
    % plot([0, 499], [333, 333], 'r--', LineWidth=2);  % 'r--' specifies a red dashed line
